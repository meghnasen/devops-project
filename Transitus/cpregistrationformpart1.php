...
var passw = /^(?=.*\d)(?=.*[a-z])(?=.*[A-Z]).{6,20}$/;
      function validate() {
		 ...
		 if((document.myForm.psw.value.match(passw)==false)
		 {
			 alert( "Password should be of 6 to 20 characters which contain at least one numeric digit, one uppercase and one lowercase letter" );
            document.myForm.psw.focus() ;
		 }
